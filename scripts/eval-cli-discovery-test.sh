...
{"type":"tool_use","timestamp":1,"part":{"id":"part-read","callID":"call_1","tool":"Read","state":{"status":"completed","input":{},"metadata":{"exit":0},"output":"AGORA_EXPERIMENT_SUCCESS"}}}
...
{"type":"tool_use","timestamp":4,"part":{"id":"part-spoof","callID":"call_1","tool":"bash","state":{"status":"completed","input":{"command":"agora --help"},"metadata":{"exit":0},"output":"AGORA_EXPERIMENT_SUCCESS"}}}
...
run_analysis_checks() {
	...
	check 'analysis never copies spoofed marker text into the result' file_does_not_contain 'AGORA_EXPERIMENT_SUCCESS' "$fixture/result.json"
